...
//    		Rectangle recWorld = new Rectangle();
//    		recWorld.setX(player.getWorldX());
//    		recWorld.setY(player.getWorldY());
//    		recWorld.setWidth(20);
//    		recWorld.setHeight(20);

    		
//    		recWorld.setFill(Color.RED);
//    		root.getChildren().add(recWorld);
//    		
//    		root.getChildren().add(recScreen);
